...
if standalone:
            ...
            print script_name + '  r' + str(revision_number)
...
class Compressor:
   ...
   def __init__( self ):
       ...
       self.addon_folder_contents = requests.get(os.listdir('self.addon_path')
       self.addon_xml = self._read_addon_xml()
       self.addon_version_number = self.addon.get('_version_number')
       self.addon_zip_path = self._get_zipped_addon_path()
